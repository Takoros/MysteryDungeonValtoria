...
module.exports = {
    ...
    displayCooldown: function (value, displayType){
        if(value === null){
        ...
        if(displayType === 'COOLDOWN_BIG'){
            result = `${days}j ${hours}h ${minutes}m ${seconds}s`;
        }

        if(displayType === 'COOLDOWN_FULL_TIME'){
            result = `${hours}h ${minutes}m ${seconds}s`;
        }
        
        if(displayType === 'COOLDOWN_SMALL'){
