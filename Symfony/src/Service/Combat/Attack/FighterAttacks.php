...
use App\Service\Combat\Attack\ExplorerAttacks;
use App\Service\Combat\Attack\GrassAttacks;
...
class FighterAttacks
{
    ...
    const DAMAGE_TYPE_PHYSICAL = 'damage_type_physical';
    const DAMAGE_TYPE_SPECIAL = 'damage_type_special';
    const DAMAGE_TYPE_MIXED = 'damage_type_mixed';
