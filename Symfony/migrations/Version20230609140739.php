 ...
 */
final class Version20230609140739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rotation (id INT AUTO_INCREMENT NOT NULL, character_id INT NOT NULL, attack_one_id INT DEFAULT NULL, attack_two_id INT DEFAULT NULL, attack_three_id INT DEFAULT NULL, attack_four_id INT DEFAULT NULL, attack_five_id INT DEFAULT NULL, type VARCHAR(50) NOT NULL, INDEX IDX_297C98F11136BE75 (character_id), INDEX IDX_297C98F1FC29468F (attack_one_id), INDEX IDX_297C98F19775A140 (attack_two_id), INDEX IDX_297C98F14936C4D2 (attack_three_id), INDEX IDX_297C98F11C126C43 (attack_four_id), INDEX IDX_297C98F140259AA8 (attack_five_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
